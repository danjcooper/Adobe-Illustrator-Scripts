...
checkbox2.helpTip = "This will get raw Excel data ready to use.";
checkbox2.text = "Raw Excel";
...
// this makes names from exel work
function processNamesFromExcel() {
